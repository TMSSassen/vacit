...
final class Version20210325091830 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE solicitatie (id INT AUTO_INCREMENT NOT NULL, user_id_id INT NOT NULL, vacature_id_id INT NOT NULL, datum DATETIME NOT NULL, uitgenodigd TINYINT(1) NOT NULL, INDEX IDX_992A48F59D86650F (user_id_id), INDEX IDX_992A48F5E836F050 (vacature_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE solicitatie');
