...
final class Version20210325092223 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_992A48F5E836F050 ON sollicitatie');
        $this->addSql('DROP INDEX IDX_992A48F59D86650F ON sollicitatie');
        $this->addSql('ALTER TABLE sollicitatie ADD user_id INT NOT NULL, ADD vacature_id INT NOT NULL, DROP user_id_id, DROP vacature_id_id');
        $this->addSql('ALTER TABLE sollicitatie ADD CONSTRAINT FK_992A48F5A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE sollicitatie ADD CONSTRAINT FK_992A48F56FB89BA0 FOREIGN KEY (vacature_id) REFERENCES vacature (id)');
        $this->addSql('CREATE INDEX IDX_992A48F5A76ED395 ON sollicitatie (user_id)');
        $this->addSql('CREATE INDEX IDX_992A48F56FB89BA0 ON sollicitatie (vacature_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sollicitatie DROP FOREIGN KEY FK_992A48F5A76ED395');
        $this->addSql('ALTER TABLE sollicitatie DROP FOREIGN KEY FK_992A48F56FB89BA0');
        $this->addSql('DROP INDEX IDX_992A48F5A76ED395 ON sollicitatie');
        $this->addSql('DROP INDEX IDX_992A48F56FB89BA0 ON sollicitatie');
        $this->addSql('ALTER TABLE sollicitatie ADD user_id_id INT NOT NULL, ADD vacature_id_id INT NOT NULL, DROP user_id, DROP vacature_id');
        ...
        $this->addSql('CREATE INDEX IDX_992A48F5E836F050 ON sollicitatie (vacature_id_id)');
        $this->addSql('CREATE INDEX IDX_992A48F59D86650F ON sollicitatie (user_id_id)');
